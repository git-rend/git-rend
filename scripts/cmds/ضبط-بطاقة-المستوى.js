...
module.exports = { config: {
		      name: "ضبط-بطاقة-المستوى",
		      aliases: ["ضبط-البطاقة"],
		      version: "1.12",
		      author: "NTKhang", // تعريب: محمد تانجيرو \\
		      countDown: 5,
		      role: 0,
		      description: { ar: "Design rank card by your own"},
		      category: "rank",
		      guide: { ar: { body: " {pn} [maincolor | subcolor | linecolor | progresscolor | alphasubcolor | textcolor | namecolor | expcolor | rankcolor | levelcolor | reset] <value>"
				         + "\n   In which: "
	...
	langs: { ar: { invalidImage: "Invalid image url, please choose an url with image destination (jpg, jpeg, png, gif), you can upload image to https://imgbb.com/ and choose \"get direct link\" to get image url",
