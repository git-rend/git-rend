...
module.exports = { config: {
		      ...
		      cooldowns: 5,
		      role: 1,
		      description: { ar: "Auto change nickname of new member"},
		      category: "box chat",
		      guide: { ar: '   {pn} set <nickname>: use to set config to auto change nickname, with some shortcuts:'
	...
	langs: { ar: { missingConfig: "Please enter the required configuration",
