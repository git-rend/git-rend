...
module.exports = { config: {
		      ...
		      category: "games",
		      guide: { ar: " {pn} [4 | 5 | 6] [single | multi]: لعبة جديدة وحدك، أو ضد شخص.\n"
				 + " [4 | 5 | 6]: عدد الأرقام في كل سطر، العدد الإفتراضي هو: 4\n"
				 + " [single | multi]: وضع اللعب؛ [single] تلعب وحدك؛ [multi] تلعب ضد، الوضع الإفتراضي هو: single\n"
				 + " مثال: {pn} أو {pn} 5 single\n\n"
	 ...
	 langs: { ar: { charts: "🏆 تصنيف أفضل اللاعبين 🏆\n༺ا-🌹━━━♡━━━🌹-ا༻\n\n%1",
		        pageInfo: "♡────ا •💜• ا────♡\n        الصفحة: %1 من %2",
			noScore: "🌹 قائمة التصنيف فارغة 🌹",
			noPermissionReset: "🌹 ليـس لديڪ الصلاحيـة\nلحـذف بيانـات اللاعبيـن 🙎‍♀️",
			notFoundUser: "العضو:%1\nلم (تـ)يلعب لعبة تخمين الأرقام\nبعد، لذا لا توجد معلومات عنه.",
			userRankInfo: "🏆 معلومات حول اللاعب 🏆\n༺ا-🌹-━━-♡-━━-🌹-ا༻\n\nالاسم: %1\nالنقاط: %2\nعدد مرات اللعب: %3\nعدد الإنتصارات: %4 فوز\n%5\nعدد الخسائر: %6 خسارة\nنسبة الفوز: %7%\nإجمالي وقت اللعب: %8",
			digits: "لعبة %1 أرقام: %2 فوز",
			resetRankSuccess: "🌹 تـم حـذف جميـع بيانـات\nاللاعبين في اللعبة بنجاح ✅",
			invalidCol: "🌹 أدخـل ࢪقمـا مـن الأࢪقـام\nالتالية: 4 أو 5 أو 6 فقط ✅",
			invalidMode: "⚠️ | Please enter the game mode is single or multi",
			created: "✅ بدايـة اللعـبة بنجـاح ✅",
		        gamemode: "🌹 وضـع اللعـب: %1 ✅",
			gameName: "لعبـة تخميـن الأرقـام",
			gameGuide: "🌹 كيفية اللعب: لديـك: 10\nتخمين، بعد كل تخمين تحصل\nعلـى تلميـحـات لعـدد الأرقـام\nالصحيـحة ولكــن ليسـت فـي\nمكـانها الصحيح (على اليسار)\nوعدد التخمينات الصحيحة في\nمكـانها الصحيح (على اليمين)",
			gameNote: "📄 ملاحظة: أرقام التخمين\nمكونة من 0 إلى 9، ولا يمكن\nأن يتكرر العدد أكثر من مرة.",
			replyToPlayGame: "🎮 ࢪد على الصورة أدناه بـ:\n%1 أࢪقام تخمنها للعب اللعبـة.",
			invalidNumbers: "🌹 أنت تلعب وضع: تخمين 5\nأࢪقام، لذا يجب إدخال 5 أࢪقام",
			win: "🎉🎊 مبارك الفوز 😍 🎊🎉\n\nخمنت الࢪقم %1 بشڪل\nصحيح، وذلك بعد %2 محاولات.\nتمت إضافة %3 نقطة إلى نقاطك",
			loss: "🤣 بووو، لقد خسࢪت 👎🤣\nالࢪقم الصحيح هو: %1"
		      }
	        },
	onStart: async function ({ message, event, getLang, commandName, args, globalData, usersData, role }) {
		if (args[0] == "الافضل") {
			...
			const rankGuessNumberText = rankGuessNumberHandle.map((item, index) => {
				...
				return `ا☜ ${item.userName} ${medal}\nفاز: ${item.winNumber} مرات، خسر: ${item.lossNumber} مرات\n`;
			}).join("\n");
			...
			if (!userDataGuessNumber)
				return message.reply(getLang("notFoundUser", targetID/*userName*/));
